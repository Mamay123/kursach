...
<html>
    ...
    <body>
        <div class="wrapper">
            <div id="article">
				<form action='ch_maintenance_drugstore.php' method='post'>
					
						<legend>Изменение записи</legend>
							<label for='id_main'>ID заказа: </label><br><input type='text' id='id_main' name='id_main' placeholder='id_main'><br>
							...
							<label for='num_order'>Заказ: </label><br><select name='num_order' id='num_order'>
								<?php
