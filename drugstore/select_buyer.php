							...
							<?php
								if($_POST['column']!== NULL)
								{
									if($_SESSION['column'] !== $_POST['column'])
									{
										if($_POST['num'] === NULL)
										{
											$pos = "SELECT * FROM buyer ORDER BY ".$_POST['column']." ASC LIMIT 50";
										}
										else 
										{
											$pos = "SELECT * FROM buyer ORDER BY ".$_POST['column']." ASC LIMIT 50 OFFSET ".$_POST['num'];
										}
									}
									else
									{
										if($_POST['num'] === NULL)
										{
											$pos = "SELECT * FROM buyer ORDER BY ".$_POST['column']." DESC LIMIT 50";
										}
										else 
										{
											$pos = "SELECT * FROM buyer ORDER BY ".$_POST['column']." DESC LIMIT 50 OFFSET ".$_POST['num'];
										}
									}
								...
								else
								{
									if($_POST['num'] === NULL)
									{
										$pos = "SELECT * FROM buyer LIMIT 50";
									}
									else 
									{
										$pos = "SELECT * FROM buyer LIMIT 50 OFFSET ".$_POST['num'];
									}
								}
								$q = mysqli_query($conn,'DESCRIBE buyer');
